...
Moved verbatim from `ASSUMPTIONS.md` on 2026-09-11, clean-up stage C2b, and not to be edited. The live
index is `ASSUMPTIONS.md`; its A-numbers count the entries below in order. Every present-tense
statement is true as of its entry's date; the index says which are still in force.
