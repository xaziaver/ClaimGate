Feature: FNOL triage
  ...
  Rule: A record is triaged and routed end to end; SIU indicators are captured as an attribute, never as a queue override
    ...
    # alone would produce.
    Scenario Outline: From raw record to queue, severity preserved and SIU indicators attached
